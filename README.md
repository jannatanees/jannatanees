...
My work focuses on developing reliable AI systems that combine machine learning, large language models, multi-agent systems, and computer vision to solve real-world problems.

I have industry experience building AI applications through internships at **Jazz** and **atomcamp**, and I'm particularly interested in **Trustworthy AI**, **Agentic AI**, **LLM Evaluation**, and **Explainable AI**.
...
PyTorch • TensorFlow • scikit-learn • Hugging Face Transformers • Diffusers • spaCy • OpenCV • Keras • NLTK

### Frameworks & Tools

FastAPI • Streamlit • Docker • Git • GitHub • CrewAI • n8n • Power BI • Jupyter Notebook
...
- Building AI systems for real-world deployment
